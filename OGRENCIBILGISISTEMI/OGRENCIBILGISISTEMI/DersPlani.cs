...
{
    public partial class DersPlani : Form
    {
        ...
        private void DersPlani_Load(object sender, EventArgs e)
        {
            baglanti.Open();
            SqlCommand ders = new SqlCommand("spdersplani", baglanti);
            ders.Parameters.AddWithValue("@ogrno", (Convert.ToInt32(ogrno)));
            SqlDataAdapter spadapter = new SqlDataAdapter("spdersplani " + Convert.ToInt32(ogrno), baglanti);
